...
-  Passes the [headless-cat-n-mouse](https://github.com/paulirish/headless-cat-n-mouse) test
...
-  All [fpscanner](https://antoinevastel.com/bots/) tests are now green, as well as all [intoli](https://bot.sannysoft.com) tests and the [`areyouheadless`](https://arh.antoinevastel.com/bots/areyouheadless) test
